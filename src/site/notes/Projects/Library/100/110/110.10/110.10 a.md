...
dg-publish: true
dg-metatags:
 description: In Kubernetes, there are tools to help you install Kubernetes, such as kops or kubespray. While they are convenient, they also have limitations and should be used appropriately and as needed. This article is a script to install GitLab via Kops.
---
