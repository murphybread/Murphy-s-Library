...
The addition may be represented graphically by placing the tail of the arrow **b** at the head of the arrow **a**, and then drawing an arrow from the tail of **a** to the head of **b**. The new arrow drawn represents the vector **a** + **b**, as illustrated below:[[7]](https://en.wikipedia.org/wiki/Euclidean_vector#cite_note-:2-7)
